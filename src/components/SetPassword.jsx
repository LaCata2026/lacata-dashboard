...
export default function SetPassword(){
  ...
  async function savePassword(){
    ...
    try{
      ...
      else{profile={id:d.id,email:d.email,name:d.user_metadata?.full_name||d.email.split("@")[0],role:getRole(d.email),avatar_color:getAvatarColor(d.email),initials:getInitials(d.user_metadata?.full_name||d.email.split("@")[0])}}
