...
export default function Icon({n,size=16,color="currentColor",style={},className=""}){
  const path=ICONS[n];if(!path)return null
  return<svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,display:"inline-block",...style}} className={className} dangerouslySetInnerHTML={{__html:path}}/>
}
